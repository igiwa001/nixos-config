...
in
  lib.mkIf cfg.enable {
    settings.hyprland.settings.monitor = [
      "desc:LG Electronics LG ULTRAGEAR 404NTGYA6311, preferred, 0x0, 1.33, bitdepth, 10"
      ...
      "desc:Hisense Electric Co. Ltd. HISENSE 0x00000001, highres, auto, auto, mirror, desc:LG Electronics LG ULTRAGEAR 404NTGYA6311, bitdepth, 10"
    ];
  }
